...
export default function HeroSection() {
    ...
    return (
        <div className="bg-secondary">
            <section className="relative bg-teal  w-11/12 pt-5 lg:pt-20  mx-auto  overflow-hidden">
                {/* HEADER TEXT */}
                ...
                <div className="flex flex-col lg:flex-row justify-between lg:-mt-20 items-center px-4 sm:px-8 lg:px-12 lg:py-12 sm:pb-16 gap-10 sm:gap-16">
                    ...
                    <div className="w-full  lg:w-1/2 relative z-10 lg:-mb-35 hidden lg:block">
                        <div className="bg-primary rounded-xl border text-primary px-6 sm:px-8 py-8 sm:py-10 flex flex-col justify-between items-start gap-8 lg:-mr-12  shadow-lg">
